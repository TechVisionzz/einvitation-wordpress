...
add_filter('manage_edit-contact_columns', function ($columns) {
...
function add_contacts_columns($columns)
{
...
add_filter('manage_edit-contact_columns', 'add_contacts_columns');
...
if (!function_exists('ei_remove_contact_taxonomy_metabox')) {
    function ei_remove_contact_taxonomy_metabox()
    {

        global $taxonomy;

        $modified_tax_arr = array('contact');
...
add_action('admin_head', 'ei_remove_contact_taxonomy_metabox');